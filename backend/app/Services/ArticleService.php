...
class ArticleService
{
    ...
    public function getArticles($request)
    {
        try {
            ...
            $dates = $this->getFilteredList($request->dates);

            $articles = $this->articleRepository->getArticles($search, $authors, $sources, $dates);
    ...
    {
        try {
            $dates = $this->articleRepository->getDates();
            ...
            Log::error('Error retrieving dates: ' . $e->getMessage());
